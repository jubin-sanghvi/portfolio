    ...
    roles: [
      {
        ...
        type: 'On-site',
        description:
          'Worked on Siebel CRM applications in an agile environment. I built, tested, and deployed components across 3 major CRM applications, handled production deployments and data migrations, and resolved real-time issues across production and test servers. This was where I first learned to operate at production scale and interface directly with clients on SLA delivery.',
      },
    ],
  },
  {
    ...
    roles: [
      {
        ...
        type: 'On-site',
        description:
          'My first role out of college. I resolved technical issues for clients across chat, email, and phone, tested products to identify and fix bugs, and built strategies to improve support efficiency. It gave me a foundation in customer empathy and systematic troubleshooting that I still carry into how I think about platform reliability today.',
      },
    ],
  },
];
